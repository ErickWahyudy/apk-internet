...
$carikode = mysqli_query($koneksi,"SELECT id_lapor FROM tb_lapor order by id_lapor desc");
$datakode = mysqli_fetch_array($carikode);
$kode = $datakode['id_lapor'];
...
<?php
    ...
    if (isset ($_POST['Simpan'])){
        ...
        $sql_simpan = "INSERT INTO tb_lapor (id_lapor, nama, no_hp, kendala, tanggal) VALUES (
           '".$format."',
           '".$_POST['nama']."',
		 			 '".$_POST['no_hp']."',
		 			 '".$_POST['kendala']."',
