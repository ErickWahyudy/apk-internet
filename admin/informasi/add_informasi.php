				...
				<form action="" method="post" enctype="multipart/form-data">
					<div class="box-body">
						<div class="form-group">
							...
							<input type="text" name="id_informasi" id="id_informasi" class="form-control" placeholder="ID Informasi" readonly="" value="<?php echo $format; ?>">
						</div>

						<div class="form-group">
							<label class="col-sm-2 control-label">Nama Informasi</label>
							<input type="text" name="informasi" id="informasi" class="form-control" placeholder="Nama Informasi">
						</div>
