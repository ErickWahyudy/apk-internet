	...
	<h1 class="fa fa-user">
		...
		<small> 
			<a href="?page=admin">Beranda</a> >
		 	...
		 	<a href="">Edit Data Admin Sistem</a>
		</small>
	</h1>
</section>
				...
				<form action="" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="box-footer">
							<a href="?page=MyApp/del_pengguna&kode=<?php echo $data_cek['id_pengguna']; ?>"
							...
							<a href="?page=MyApp/data_pengguna" title="Kembali" class="btn btn-warning">Batal</a>&emsp;
