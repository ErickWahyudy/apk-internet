				...
				<form action="" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input type='text' class="form-control" name="id_feedback" value="<?php echo $data_cek['id_feedback']; ?>"
							 readonly/>
						</div>
						...
						<div class="form-group">
							<label>Nilai</label>
							<input type="number" class="form-control" name="nilai" value="<?php echo $data_cek['nilai']; ?>"
							/>
						</div>

						<div class="form-group">
							<label>Feedback</label>
							<input type="text" class="form-control" name="feedback" value="<?php echo $data_cek['feedback']; ?>"
							/>
						</div>
						...
						<div class="box-footer">
							<a href="?page=del-feedback&kode=<?php echo $data_cek['id_feedback']; ?>" onclick="return confirm('Yakin Hapus Data Ini ?')" title="Hapus" class="btn btn-danger">
