				...
				<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="date" class="form-control" id="tgl_bayar" name="tgl_bayar" value="<?php echo $data_cek['tgl_bayar']; ?>" readonly/>
							</div>
						</div>
						...
						<div class="box-footer">
							<a href="?page=del-tagihan&kode=<?php echo $data_cek['id_tagihan']; ?>" onclick="return confirm('Yakin Hapus Data Ini ?')"
