	...
	<h1 class="fa fa-table">
		...
		<small> 
			<a href="?page=admin">Beranda</a> >
		 	<a href="?page=buat-tagihan">Buat Tagihan</a>
		</small>
	</h1>
</section>
...
<div class="box-footer">
							...
							<input type="submit" name="Simpan" value="Buat Tagihan" class="btn btn-primary">
										...
										<?php
										$no = 1;
										$sql = $koneksi->query("SELECT p.id_pelanggan, p.nama, p.email, p.status_plg, k.paket, k.tarif from tb_pelanggan p inner join 
