				...
				<form class="form-horizontal" action="sendemail.php" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="nama_pengirim" name="nama_pengirim" autocomplete="off" value="KASSANDRA WiFi" required>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="ttd" name="ttd" autocomplete="off" value="wifi@kassandra.my.id" required>
							</div>
						</div>
