...
<head>
    ...
    <meta charset="utf-8">
    <title>PROMO KASSANDRAWIFI</title>
    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav me-auto p-3 p-lg-0">
                ...
                <a href="promo.php" class="nav-item nav-link active">Promo</a>
...
<?php }elseif($stt == 'tidak ada promo'){ ?>
 ...
 <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h6 class="section-title bg-white text-center text-primary px-3">Register Us</h6>
                <h5 class="display-8 mb-4">PROMO PEMASANGAN BARU SUDAH BERAKHIR</h5>
                <p>Selalu nantikan update berkala dari kami untuk mendapatkan promo menarik lainnya..</p>
            </div>
            <!-- Modal iklan -->
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" style="text-align:center">
			<b>PROMO PEMASANGAN BARU SUDAH BERAKHIR</b>
        </h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <!-- Facts Start -->
      <p>We’re sorry, the page you have looked for does not exist in our website! Maybe go to
                        our home page or try to use a search?</p>
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="fact-item bg-light rounded text-center h-100 p-5">
                        <i class="fa fa-certificate fa-4x text-primary mb-4"></i>
                        <h5 class="mb-3">Biaya Pemasangan Normal</h5>
						<h4 class="mb-3"><del style="color:red">Rp. 1.000.000,00</del></h4>
                        <h4 class="mb-3">Rp. 350.000,00</h4>
                        <h6 class="text-muted"><small>S&k berlaku</small></h6>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            ...
            <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
                <div class="container text-center">
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <a href="landingpage.php" class="btn btn-success">Home</a>
                        </div>
                    </div>
                </div>
            </div>
