...
message = "<b>Pesan dari web KassandraWiFi</b>%0Anama : "+ $("#nama").val() + "%0Aalamat : " + $("#alamat").val() + "%0Ano. hp : wa.me/62" + $("#nomor").val() + "<b>%0Asubject pesan : </b>" + $("#subject").val() + "%0Apesan : " + $("#pesan").val();
